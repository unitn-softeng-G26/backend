...
if __name__ == "__main__":
    ...
    with db_session:
        ...
        if not Corso.exists():
            ...
            Corso(nome="Analisi 1", crediti=12, docente=d6)
            Corso(nome="Analisi 2", crediti=12, docente=d6)
            Corso(nome="Fisica", crediti=12, docente=d6)
            Corso(nome="Programmazione 1", crediti=12, docente=d5)
            Corso(nome="Programmazione 2", crediti=12, docente=d5)
            Corso(nome="Ingegneria del Software", crediti=12, docente=d1)
            Corso(nome="Algoritmi e Strutture Dati", crediti=12, docente=d5)
            Corso(nome="Basi di Dati", crediti=12, docente=d3)
            Corso(nome="Reti", crediti=12, docente=d2)
            Corso(nome="Sistemi Operativi", crediti=12, docente=d2)

            Corso(nome="Probabilità e Statistica", crediti=6, docente=d1)
            Corso(nome="Programmazione Funzionale", crediti=6, docente=d1)
            Corso(nome="Algebra Lineare", crediti=6, docente=d6)
            Corso(nome="Fondamenti Matematici", crediti=6, docente=d3)
            Corso(nome="Calcolatori", crediti=6, docente=d5)
            Corso(nome="Logica", crediti=6, docente=d3)
            Corso(nome="Sistemi Informativi", crediti=6, docente=d2)
            Corso(nome="Sviluppo Web", crediti=6, docente=d4)
            Corso(nome="Human-Conputer Interaction", crediti=6, docente=d4)
            Corso(nome="Network Security", crediti=6, docente=d4)
